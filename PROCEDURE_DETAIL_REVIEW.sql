...
EXEC uspINSERTREVIEW @CommentDesc = 'Love the long battery life but the storage space is way too low for the price.', @RatingValue = 3, @Quantity = , @LaptopName = 'Asus ZenBook 13', @Fname = 'Bob', @Lname = 'Blekins', @BirthDate = '2001-01-04', @Odate = '2019-10-24'
