...
GO
ALTER TABLE tblLAPTOP
ADD CONSTRAINT FK_ColorID FOREIGN KEY (ColorID) REFERENCES tblCOLOR(ColorID)

GO
ALTER TABLE tblLAPTOP
ADD BatteryLifeID INT

GO
ALTER TABLE tblLAPTOP
ADD CONSTRAINT FK_BatteryLifeID FOREIGN KEY (BatteryLifeID) REFERENCES tblBATTERY_LIFE(BatteryLifeID)
...
GO
ALTER TABLE tblLAPTOP
ADD CONSTRAINT FK_WeightID FOREIGN KEY (WeightID) REFERENCES tblWEIGHT(WeightID)
...
GO
ALTER TABLE tblLAPTOP
ADD CONSTRAINT FK_PriceID FOREIGN KEY (PriceID) REFERENCES tblPRICE(PriceID)