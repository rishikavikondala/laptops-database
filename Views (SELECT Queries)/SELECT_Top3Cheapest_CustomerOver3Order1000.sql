...
--Find the three lowest priced laptops that run on Windows 10 Home, was released in 2019, has at least 1 speaker and weighs more than 3 lbs.
...
--Find the customers who have ordered over $1000 of laptop(s) in the last six months that also have an average rating over 3 stars.
...
SELECT P.ProductID, AVG(R.RatingValue) AS AverageRating
	...
	HAVING AVG(R.RatingValue) > 3) AS subq1 ON P.ProductID = subq1.ProductID
