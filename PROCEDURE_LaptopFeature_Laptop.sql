...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Front-facing camera with full HD video', @LaptopName = 'Microsoft Surface Pro 7'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Front-facing camera with full HD video', @LaptopName = 'Microsoft Surface Laptop 3'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Windows', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'UHD QLED Display', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = '10th Generation Intel Core i7', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'GeForce MX250', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Windows Hello', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'HD Webcam', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'AKG Speaker', @LaptopName = 'Samsung Galexy Book Flex'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'SSD', @LaptopName = 'Samsung Galexy Book Flex'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'HD Webcam', @LaptopName = 'Lenovo ThinkPad X1'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Stereo Speaker', @LaptopName = 'Dell Precision 5540'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'HD Webcam', @LaptopName = 'Lenovo Chromebook S330'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'HD Webcam', @LaptopName = 'MSI GT76 TITAN DT-039'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'HD Webcam', @LaptopName = 'VivoBook 15'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Stereo Speakers', @LaptopName = 'VivoBook 15'
...
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'HD Webcam', @LaptopName = 'Acer Nitro 5 Gaming Laptop'
EXEC uspINSERTLAPTOPFEATURE @FeatureName = 'Stereo Speakers', @LaptopName = 'Acer Nitro 5 Gaming Laptop'
